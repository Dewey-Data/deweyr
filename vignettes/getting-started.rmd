...
Before downloading, use `preview_dewey_duck()` to explore the dataset — see column names, types, and a sample of the data:
...
df_preview <- preview_dewey_duck(api_key, data_id)
df_preview
```
